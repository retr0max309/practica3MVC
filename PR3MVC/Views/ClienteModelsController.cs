...
namespace PR3MVC.Views
{
    public class ClienteModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombres,Apellidos,CI,Celular,Correo,Direccion")] ClienteModel clienteModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombres,Apellidos,CI,Celular,Correo,Direccion")] ClienteModel clienteModel)
        {
